...
let spr_water = new Sprite("spr_water","game/sprites/tilese2.png",132,0,32,48,32,48,.1);
let spr_wood = new Sprite("spr_wood","game/sprites/tiles.png",[0,32],176,32,48,32,48);